...
THREE.VRRenderer = function(renderer, hmd) {
    ...
    self.initialize = function() {
        ...
        self.halfIPD = new THREE.Vector3(epLeft.eyeTranslation.x, epLeft.eyeTranslation.y, epLeft.eyeTranslation.z).length();
        self.fovLeft = epLeft.recommendedFieldOfView;
        self.fovRight = epRight.recommendedFieldOfView;
    }
    ...
    self.render = function(scene, camera) {
        ...
        var width = renderer.domElement.width / 4;
